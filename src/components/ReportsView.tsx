...
export const ReportsView: React.FC<ReportsViewProps> = ({
  ...
  const handleTriggerClearRecords = () => {
    ...
    setConfirmDialog({
      isOpen: true,
      title: 'Erase Attendance Report Logs',
      message: `Are you sure you want to completely erase all ${attendanceRecords.length} attendance verification records? This will reset all analytics charts, percentages, and session history back to zero.`,
      confirmText: 'Yes, Erase All Report Logs',
      cancelText: 'Cancel',
      variant: 'danger',
      onConfirm: () => {
        onClearAttendance();
        showToast('All attendance report logs have been erased.');
      }
    });
  };
    ...
    <div className="space-y-6 animate-in fade-in duration-300 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 self-start sm:self-auto flex-wrap">
          {onClearAttendance && attendanceRecords.length > 0 && (
            <button
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Faculty Attendance Rate</span>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          ...
          <div className="mt-2 flex items-baseline justify-between">
            <span className="text-3xl font-black text-slate-900 font-mono">{teachers.length}</span>
